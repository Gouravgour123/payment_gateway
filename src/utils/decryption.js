...
// function decrypt(data, secretKey, secretIV) {
//     console.log(secretKey)
//     const decipher = crypto.createDecipheriv('aes-256-cbc', Buffer.from(secretKey, 'utf-8'), secretIV);
...
// module.exports={decrypt,decryptBase64}
